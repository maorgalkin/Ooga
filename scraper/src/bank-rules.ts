 ...
 * Debit-card purchases ("כרטיס דביט") are real expenses and don't match.
 */
...
export const isCardBillPayment = (description: string | null | undefined) =>
  !!description && CARD_BILL_PATTERNS.some(pattern => pattern.test(description));
